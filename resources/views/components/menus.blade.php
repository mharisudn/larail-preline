...
<div class="hs-dropdown relative inline-flex">
    <button id="hs-dropdown-with-title" type="button"
            class="hs-dropdown-toggle py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg bg-white text-gray-800 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800">
        ...
        <span class="flex flex-col items-start justify-center flex-shrink-0 h-full leading-none translate-y-px">
            <span>{{ $title }}</span>
            <span class="text-xs font-light text-neutral-400">{{ $subtitle }}</span>
        </span>
